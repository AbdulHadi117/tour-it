...
type FormState = "default" | "loading" | "success" | "expired" | "error";
  ...
  return (
    <div className="flex items-center gap-2.5">
      <div
        ...
        style={{
          background: valid ? "#0E8C88" : "#F0EDE6",
      ...
      <span
        ...
        style={{ color: valid ? "#0E8C88" : "#9CA3AF" }}
      >
        {label}
      </span>
    </div>
...
function SuccessCard({ onNavigate }: { onNavigate: (p: Page) => void }) {
  return (
    <div
      className="flex flex-col items-center rounded-[20px] border border-[#DDD6C7] bg-white px-8 py-10 shadow-[0_12px_40px_rgba(18,35,58,0.08)]"
      style={{ width: 420 }}
    >
      <div
        className="h-1 w-full rounded-t-[20px] bg-[#0E8C88] -mt-10 mb-8 self-stretch"
        style={{
          marginLeft: -32,
          marginRight: -32,
          width: "calc(100% + 64px)",
      ...
      />
      <div
        className="flex h-18 w-18 items-center justify-center rounded-full bg-[#0E8C88] shadow-[0_8px_24px_rgba(14,140,136,0.35)] mb-6"
        style={{ width: 72, height: 72 }}
      >
        <CheckCircle2 size={32} className="text-white" strokeWidth={1.75} />
      </div>
      <h3
        className="text-[#12233A] text-xl font-bold text-center mb-2"
...
function ExpiredCard({ onNavigate }: { onNavigate: (p: Page) => void }) {
  return (
    ...
    >
      <div
        className="flex h-18 w-18 items-center justify-center rounded-full bg-[#E15B3F] shadow-[0_8px_24px_rgba(225,91,63,0.35)] mb-6"
        style={{ width: 72, height: 72 }}
      >
      ...
      <p className="text-[#6B7280] text-sm text-center leading-6 mb-6">
        ...
        valid for 30 minutes — please request a new one.
      </p>
      <div className="w-full border-t border-[#DDD6C7] mb-6" />
...
export default function PasswordResetPage({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const isTokenIssue = /invalid|expired/i.test(message);
      setFormState(isTokenIssue ? "expired" : "error");
      setErrorMsg(message);
    }
  };
    ...
    <main className="min-h-[calc(100vh-80px)] flex">
      ...
      <div className="hidden lg:block relative w-1/2 overflow-hidden bg-[#12233A]">
        ...
        <div
          ...
          style={{ background: "rgba(18,35,58,0.80)" }}
        />
        <div
        ...
        <div className="relative h-full flex flex-col justify-between p-12 xl:p-16">
          ...
          <div className="max-w-md">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-white/70 text-sm leading-6">
                    Keep planning your travel itineraries safely. A strong
                    password keeps your saved trips, wishlist, and personal data
                    protected.
                  </p>
                </div>
              </div>
            ...
            <p className="text-white/60 text-sm leading-7">
              Set a new password and you'll be back planning your next adventure
              in seconds.
            </p>
          </div>
      ...
      <div className="flex w-full lg:w-1/2 flex-col justify-center bg-[#FAF8F3] px-6 py-12 overflow-y-auto">
        <div className="w-full mx-auto" style={{ maxWidth: 480 }}>
          ...
          >
            ...
            <div className="flex flex-col" style={{ gap: 6 }}>
              ...
              <div className="flex items-center gap-3 rounded-2xl border border-[#DDD6C7] bg-white px-4 py-3.5 focus-within:border-[#0E8C88] transition-colors">
                ...
                <button
                  ...
                  className="text-[#9CA3AF] hover:text-[#12233A] transition-colors"
                >
            ...
            <div
              className="rounded-2xl border border-[#DDD6C7] bg-white px-5 py-4 flex flex-col"
              style={{ gap: 10 }}
            >
              <p className="text-[10px] font-bold uppercase tracking-widest text-[#12233A]/50 mb-1">
            ...
            <button
              ...
              style={{
                background: "#0E8C88",
                opacity: formState === "loading" ? 0.8 : !allValid ? 0.5 : 1,
              }}
            >
              {formState === "loading" ? (
                <>
            ...
            <div className="flex justify-center pt-1">
              <button
                type="button"
                onClick={() => onNavigate("auth")}
                className="flex items-center gap-1.5 text-sm font-semibold text-[#12233A] opacity-50 hover:opacity-90 transition-opacity"
              >
                <ArrowLeft size={13} /> Back to Sign In
              </button>
            </div>
